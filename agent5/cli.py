...
def build_parser() -> argparse.ArgumentParser:
    ...
    flowchart_parser = subparsers.add_parser(
        "flowchart",
        help="Generate a Mermaid flowchart from JSON AST (generated by build-ast command)",
    )
    ...
    flowchart_parser.add_argument(
        ...
        type=_path,
        default=None,
        help="Path to JSON AST file (if not provided, will look for ast_with_calls.json in project_path or file directory)",
    )
    ...
    flowchart_parser.add_argument(
        ...
        type=_path,
        default=None,
        help="Optional: Path to C++ source file (for reference only, helps locate AST JSON)",
    )
    ...
    flowchart_parser.add_argument(
        ...
        type=_path,
        default=None,
        help="Project root path (used to locate AST JSON if --ast-json not provided)",
    )
    ...
    flowchart_parser.add_argument(
        ...
        default="medium",
        help="Detail level: high (top-level only), medium (default), deep (expanded sub-operations)",
    )
    ...
    # Legacy options (for backward compatibility with scenario mode)
    flowchart_parser.add_argument(
        "--scenario",
        type=str,
        default=None,
        help="[Legacy] Scenario/operation name (requires --collection, not used with --ast-json)",
    )
    flowchart_parser.add_argument(
        "--collection",
        default=None,
        help="[Legacy] Collection name (required for --scenario mode only)",
    )
    flowchart_parser.add_argument(
        "--k",
        type=int,
        default=20,
        help="[Legacy] Number of code chunks to retrieve (for --scenario mode only)",
    )
